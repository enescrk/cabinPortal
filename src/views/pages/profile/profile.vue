    ...
    <div class="row">
      <div class="col-xl-8">
              ...
              <div class="p-4">
                <div class="media align-items-center">
                  ...
                  <div class="media-body overflow-hidden">
                    <h5 class="font-size-16 mb-1">Profil Bilgisi</h5>
                    <p class="text-muted text-truncate mb-0">
                      CabinFit hesap bilgileri
                    </p>
                  </div>
                  <i
                ...
                <form>
                  <div>
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group mb-4">
                          <label for="billing-name">İsim</label>
                          <input
                            type="text"
                            class="form-control"
                            id="billing-name"
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group mb-4">
                          <label for="billing-name">Web sitesi Url</label>
                          <input
                            type="text"
                            class="form-control"
                            id="billing-name"
        ...
        <div class="row my-4">
          ...
          <div class="col">
            <div class="text-sm-right mt-2 mt-sm-0" @click=" goToSuccessPage()">
              <a class="btn btn-success">
                <i class="uil uil-shopping-cart-alt me-1"></i> Bilgileri Kaydet
              </a>
            </div>
          </div>
        ...
        <div class="card checkout-order-summary">
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-centered mb-0 table-nowrap w-100">
                <thead>
                  <tr>
                   
                    <th class="border-top-0" scope="col">Paket</th>
                    <th class="border-top-0" scope="col">Ücret</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
