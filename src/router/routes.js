...
export default [{
...

  {
    ...
    component: () => import('../views/pages/patterns/patterns')
  },
  {
    path: '/products',
    name: 'Ürünlerim',
  ...
  },
  {
    ...
    component: () => import('../views/pages/finance/finance')
  },
  {
    path: '/success',
    name: '',
    ...
    component: () => import('../views/pages/success/success')
  },
  {
    path: '/createPattern',
    name: '',
  ...
  },
  {
    ...
    component: () => import('../views/pages/createPatternFromExcel/createPatternFromExcel')
  },
  {
